...
extern status_t platform_convert_to_kernel_address(void *address, uint64_t *_result);
extern status_t platform_convert_to_loader_address(uint64_t address, void **_result);
