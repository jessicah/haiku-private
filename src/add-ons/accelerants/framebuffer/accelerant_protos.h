...
// 2D acceleration
void framebuffer_screen_to_screen_blit(engine_token *et, blit_params *list,
	uint32 count);
void framebuffer_fill_rectangle(engine_token *et, uint32 color, fill_rect_params *list,
	uint32 count);
void framebuffer_invert_rectangle(engine_token *et, fill_rect_params *list,
	uint32 count);
void framebuffer_fill_span(engine_token *et, uint32 color, uint16 *list, uint32 count);
